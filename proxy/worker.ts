// Minimal CORS proxy for git smart-HTTP, deployable as a Cloudflare Worker.
// Usage in peeponote settings: https://<your-worker>.workers.dev
// Deploy: npx wrangler deploy proxy/worker.ts --name peeponote-proxy --compatibility-date 2024-01-01
//
